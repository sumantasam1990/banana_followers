...
<head>
    ...
    <title>Banana Followers Register</title>
                ...
                <div class="card mb-4 mx-4">
                    <form action="{{route('auth.register.post')}}" method="post">
                        ...
                        <div class="card-body p-4">
                            <h1 class="text-primary">Create your account</h1>
                            <p class="text-medium-emphasis">Create your free account and start ordering to get lots of followers for your social media accounts.</p>
                            <div class="input-group mb-3"><span class="input-group-text">
                  <svg class="icon">
                    <use xlink:href="{{asset('vendors/@coreui/icons/svg/free.svg#cil-user')}}"></use>
                  </svg></span>
                                <input class="form-control @error('fname') is-invalid @enderror" type="text" placeholder="Full name" name="fname" value="{{old('fname')}}">
                                @error('fname')
