                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-tab-card">
                                        ...
                                        <ol class="list-group mb-4">
                                            @foreach($data as $d)
                                                <li class="mb-2 list-group-item @if(auth()->user()->id === $d->ticket->user_id) list-group-item-secondary @else '' @endif d-flex justify-content-between align-items-start">
                                                    <div class="ms-2 me-auto">
                                                        <div class="fw-bold">{{auth()->user()->id === $d->ticket->user_id ? auth()->user()->name : 'Admin'}}</div>
                                                        {{$d->message}}
                                                    </div>
